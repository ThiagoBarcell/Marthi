object frmCadInformacoes: TfrmCadInformacoes
  ...
  object PgeCadastroComp: TcxPageControl
    ...
    Align = alClient
    TabOrder = 0
    Properties.ActivePage = tabTpPreco
    ...
    object tabTpPreco: TcxTabSheet
      ...
      object grdTpPreco: TcxGrid
        ...
        LookAndFeel.NativeStyle = False
        LookAndFeel.SkinName = 'UserSkin'
        object grdTpPrecoDBTableView: TcxGridDBTableView
          Navigator.Buttons.CustomButtons = <>
          Navigator.Buttons.First.Visible = True
          Navigator.Buttons.PriorPage.Visible = True
          Navigator.Buttons.Prior.Visible = True
          ...
          Navigator.Buttons.Filter.Visible = False
          Navigator.Visible = True
          DataController.DataSource = frmGeralDM.dtsCellTpPreco
          DataController.Summary.DefaultGroupSummaryItems = <>
          DataController.Summary.FooterSummaryItems = <>
          DataController.Summary.SummaryGroups = <>
          OptionsBehavior.GoToNextCellOnEnter = True
          ...
          object grdTpPrecoDBColumn: TcxGridDBColumn
            Caption = 'Tipos de Pre'#231'o'
            DataBinding.FieldName = 'TP_PRECO_DESC'
            HeaderAlignmentHorz = taCenter
          end
        end
        object grdTpPrecoLevel: TcxGridLevel
          GridView = grdTpPrecoDBTableView
        end
      end
    end
  end
